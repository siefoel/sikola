        ...
        <ul id="sidebarnav">
            ...
            <ul aria-expanded="false" class="collapse first-level">
              ...
              <li class="sidebar-item">
                <a href="/verifysekolah" class="sidebar-link">
                  ...
                  <span class="hide-menu">Verifikasi Pendaftaran</span>
                </a>
              </li>
            </ul>
          </li>
            ...
            <ul aria-expanded="false" class="collapse first-level">
              ...
              <li class="sidebar-item">
                <a href="blog-detail.html" class="sidebar-link">
                  ...
                  <span class="hide-menu">Setting Matapel</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="blog-detail.html" class="sidebar-link">
                  ...
                  <span class="hide-menu">Setting Kelas</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="blog-detail.html" class="sidebar-link">
                  ...
                  <span class="hide-menu">Setting Jadwal</span>
                </a>
              </li>
            </ul>
          </li>
          ...
          <li class="sidebar-item">
            <a class="sidebar-link" href="index.html" aria-expanded="false">
              ...
              <span class="hide-menu">Jadwal Pembelajarn</span>
            </a>
          </li>
          <li class="sidebar-item">
            <a class="sidebar-link has-arrow" href="#" aria-expanded="false">
              ...
              <span class="hide-menu">Admin Pembelajaran</span>
            </a>
            <ul aria-expanded="false" class="collapse first-level">
              <li class="sidebar-item">
                <a href="blog-posts.html" class="sidebar-link">
                  ...
                  <span class="hide-menu">Silabus</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="blog-detail.html" class="sidebar-link">
                  ...
                  <span class="hide-menu">Rancangan Pembelajaran</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="blog-detail.html" class="sidebar-link">
                  ...
                  <span class="hide-menu">Modul Ajar</span>
                </a>
              </li>
              <li class="sidebar-item">
                <a href="blog-detail.html" class="sidebar-link">
